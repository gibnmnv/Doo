...
InfiniteBox:AddToggle('InfiniteItems', {
	Text = "Infinite Lockpicks / SkeletonKey",
...
Bypass:AddSlider("AnticheatManipulationSpeed", {
        Text = "Anti Cheat Manipulation Speed",
        Default = 0.2,
        Min = 0.15,
        Max = 0.45,
        Rounding = 2,
...
Library:Notify("Loading 206脚本中心 ðŸ¥­ for OP Ninja Simulator ",5)
